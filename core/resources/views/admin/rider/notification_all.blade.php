            ...
            <div class="row  mb-4 justify-content-center">
                <div class="col-sm-7">
                    <div class="row gy-4 justify-content-center">
                        @include('admin.rider.notification_widget')
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <small class="text--info d-none userCountText mt-2 d-block"> <i class="las la-info-circle"></i>
                                        <strong class="userCount">0</strong> @lang('active riders found to send the notification')</small>
                                </div>
    ...
    <script>
        ...
        (function($) {
            ...
            $('select[name=being_sent_to]').on('change', function(e) {
                ...
                if (methodName == 'SELECTEDUSERS') {
                    ...
                    <div class="form-group position-relative" id="user_list_wrapper">
                        <label class="required form-label">@lang('Select Rider')</label>
                ...
                if (methodName == 'TOPDEPOSITEDUSERS') {
                    $('.input-append').html(`
                    <div class="form-group">
                        <label class="required">@lang('Number Of Top Deposited Rider')</label>
            ...
            function getUserCount(methodName) {
                ...
                var route = "{{ route('admin.rider.segment.count', ':methodName') }}"
